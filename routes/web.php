...
Route::get('/email/verify/{id}/{hash}', function (EmailVerificationRequest $request) {
	$request->fulfill();
	if($request->id){
		$student = UserModel::where('id' , $request->id)->get()->first();
		$inquiry = InquiryModel::where('student_id' , $request->id)->get()->first();
		sendMail([
            'view' => 'email.inquiry_mail_to_admin',
            'to' => 'onlinequrantuitionuk@gmail.com',
            'subject' => 'New Adult inquiry form Submitted',
            'name' => $student->name,
            'data' => [
                'user' => $student,
                'inquiry' => $inquiry,
        ...
        sendMail([
            ...
            'data' => [
                'user' => $student,
                'email' => $student->email,
                'password' => 'You choosed at the time of enrollment',
            ],
        ]);
    }
...
Route::name('student.')->group(function () {
    Route::prefix('student')->group(function () {
        ...
        Route::middleware(['student', 'verified'])->group(function () {
            ...
            Route::get('/add/multiple/subscription/{id}', [ChildrenController::class, 'multiple_subscription'])->name('multiple.subscription');
