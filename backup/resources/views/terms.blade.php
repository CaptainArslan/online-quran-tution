    ...
    <div class="container my-5">
        <div class="row green-background borderRoundClass pt-4">
            <div class="col-lg-12 px-0 skin-background borderRoundClass">
                ...
                <ul>
                    <li>In order to use a content or a part of it, you must attribute it to slidesgo / Freepik, so we will be able to continue creating new graphic 
                ...
                <div class="green-background text-skin px-5 py-3">
                    ...
                    <ul>
                        <li>For websites: Please, copy this code on your website to accredit the author: Designed by slidesgo / Freepik</li>
                        <li>For printing: Paste this text on the final work so the authorship is known. - For example, in the acknowledgements chapter of a book: 
                ...
                <div class="px-5 my-3">
                    <h3>The full terms of the license are described in section 7 of the Freepik terms of use, available online in the following link:</h3>
                    <ul>
                        <li>http://www.freepik.com/terms_of_use</li>
                        <li>The terms described in the above link have precedence over the terms described in the present document. In case of disagreement, 
        ...
        <div class="row green-background borderRoundClass mt-5 pt-4">
            <div class="col-lg-12 px-0 pb-5 skin-background borderRoundClass">
                ...
                <div class="green-background text-skin px-5 py-3 mb-3">
                    <h3>The full terms of the license are described in sections 7 and 8 of the Freepik terms of use, available online in the following link:</h3>
                    <ul>
                        <li>http://www.freepik.com/terms_of_use</li>
                        <li>The terms described in the above link have precedence over the terms described in the present document. In case of disagreement</li>
