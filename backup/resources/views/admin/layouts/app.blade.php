                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{Auth::user()->name}}</span><span class="user-status text-success">Online</span></div><span><img class="round" src="{{asset(Auth::user()->avatar)}}" alt="avatar" height="40" width="40"></span>

                            </a>
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('admin.user_Profile')}}"><i class="feather icon-user"></i> Profile</a>
...
<!---------------------------------------------->
            ...
            <script src="{{asset('admin_theme')}}/app-assets/vendors/js/tables/datatable/datatables.bootstrap4.min.js">
            </script>
...
<script>
    ...
    function getData(page){
        ...
        $.ajax({
            url: '?page=' + page + '&table_length_limit=' + $('.table_length_limit').val()+'&'+searchParams+'&table_filter_search='+table_filter_search,
            type: "get",
            datatype: "html"
        }).done(function(data){
            $("#append-record").empty().html(data);
    ...
    $(document).on('change', '.table_length_limit',function(event){
        ...
        $.ajax(
            {
                url: '?table_length_limit=' + $(this).val()+'&'+searchParams+'&table_filter_search='+table_filter_search,
                type: "get",
                datatype: "html"
            }).done(function(data){
            $("#append-record").empty().html(data);
    ...
    $(document).on('keyup', '.table_filter_search',function(event){
        ...
        delay(function(){
            ...
            let   searchParams = new URLSearchParams(window.location.search);
            $.ajax({
                url: '?table_filter_search='+table_filter_search+'&table_length_limit=' + $('.table_length_limit').val()+'&'+searchParams,
                type: "get",
                datatype: "html"
            }).done(function(data){
                $("#append-record").empty().html(data);
