                                            ...
                                            <div class="accordion" id="accordionExample" data-toggle-hover="true">
                                                <div class="collapse-margin">
                                                    ...
                                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.support.save_comment') }}" method="POST">
                                                                @csrf
                                                                <input type="hidden" name="ticket_id" id="ticket_id" value="{{ $ticket->id }}">
                                                                <textarea data-length="20" class="form-control" rows="5" name="comment"></textarea>
                                                                <div class="row">
                                        ...
                                        @if (count($ticket->comments)>0)
                                            @foreach ($ticket->comments as $item)
                                                @if ($item->user_id == auth()->user()->id)
                                                    <div class="col-12">
                                                        <div class="card blue-bg jumbotron">
                                                            <div class="card-content">
                                                                <div class="card-body">
                                                                    <div class="row">
