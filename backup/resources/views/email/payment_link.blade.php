			...
			<table border="0" cellpadding="0" cellspacing="0" align="center"
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;  padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
						...
						Mail by Live Learning to Proceed Payment
					</td>
				</tr>
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
				...
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
                        ...
                        Thank you for Joining Live Learning Platform. Click the link to pay your payments against your inquiry submitted recently to start your classes.
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
						...
						<a href="{{ route('payment.mail.paypal') }}?plan={{ $data['plan_id'] }}&inquiry={{ $data['inquiry_id'] }}&email={{ $data['email'] }}" target="_blank" style="text-decoration: none;">
								...
								<tr>
									<td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: none; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
										...
										<a target="_blank" style="text-decoration: none;
											...
											href="{{ route('payment.mail.paypal') }}?plan={{ $data['plan_id'] }}&inquiry={{ $data['inquiry_id'] }}&email={{ $data['email'] }}">
											Proceed Now
										</a>
									</td>
								</tr>
				...
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
                        ...
                        font-size: 14px;" href="{{ route('payment.mail.paypal') }}?plan={{ $data['plan_id'] }}&inquiry={{ $data['inquiry_id'] }}&email={{ $data['email'] }}">{{ route('payment.mail.paypal') }}?plan={{ $data['plan_id'] }}&inquiry={{ $data['inquiry_id'] }}&email={{ $data['email'] }}</a>
					</td>
				</tr>
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
