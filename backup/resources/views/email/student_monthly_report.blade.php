			...
			<table border="0" cellpadding="0" cellspacing="0" align="center"
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;  padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
						...
						Monthly Reviews Report by Live Learning 
					</td>
				</tr>
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
				...
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
                        ...
                        Your monthly reviews report from Tutor last month.
                	</td>
				</tr>

				<tr>
								<td align="center" colspan="6" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			<table  cellpadding="0" cellspacing="0" align="center"
					...
					width: 600px;" class="wrapper">
						...
						<thead style="border: 1.5px solid;">
							<tr>
								<th style="padding: 6px;border:1.5px solid;">Sr#</th>
								<th style="border:1.5px solid;">Tutor</th>
								<th style="border:1.5px solid;">Avg. Behavior</th>
								<th style="border:1.5px solid;">Avg. Progress</th>
								<th style="border:1.5px solid;">Avg. Attention</th>
							</tr>
						</thead>
						<tbody>
						    @foreach($data['tutor_ids'] as $tutor_id)
						        @php
    							    $review=$data['reviews']->where('tutor_id',$tutor_id);
    							    $tutor=App\Models\User::where('id',$tutor_id)->first();
    							@endphp
    						    
    							    
        							<tr >
        								<th style="padding: 6px;border:1.5px solid;">{{$loop->iteration}}</th>
        								<th style="border:1.5px solid;" >{{$tutor->name}}</th>
        								<th  style="border:1.5px solid;" >{{number_format($review->avg('behavior'),1)}}</th>
        								<th  style="border:1.5px solid;" >{{number_format($review->avg('progress'),1)}}</th>
        								<th  style="border:1.5px solid;" >{{number_format($review->avg('attention'),1)}}</th>
        							</tr>
    
                                
                            @endforeach
								<tr>
								<td align="left" valign="top"  colspan="6" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 15px; font-weight: 400; line-height: 160%;
									padding-top: 15px;
									color: #FFFFFF;
							...
							<tr>
								<td align="center" colspan="6" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
									padding-top: 10px;
									padding-bottom: 20px;
									color: #828999;
