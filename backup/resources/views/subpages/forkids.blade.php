    ...
    <div class="container p-5">
        <div class="row">
            <div class="col-md-6 mt-5 py-5">
                ...
                <a class="btn green-background text-skin mb-3" href="#" style="border-radius: 2px;">
                    Get A Free Trial
                </a>
            </div>
            <div class="col-md-6">
...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <img alt="" class="img-fluid" src="{{asset('/public/dist/img/exports/Frame 15.png')}}">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img alt="" class="img-fluid" src="{{asset('/public/dist/img/exports/Rectangle 9 new.png')}}">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <p class="text-white mt-2">ALHAMDULLILAH</p>
                <h3 class="text-skin">
                    {!! $p2h !!}
                </h3>
                <p class="text-white">
...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <img alt="" class="img-fluid" src="{{asset('/public/dist/img/exports/Frame 16.png')}}">
            </div>
        </div>
    </div>
</section>
...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img alt="" class="img-fluid" src="{{asset('/public/dist/img/exports/Frame 17.png')}}">
            </div>
            <div class="col-md-6">
                <p>ALHAMDULLILAH</p>
                <h3 class="text-green">
