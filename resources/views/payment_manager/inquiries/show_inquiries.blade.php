                                    ...
                                    @if ($student->user)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    @if ($student->status == 'on_trial')
                                                        <a href="{{ route('admin.shared.change.inquiry.status', [$student->id, 'started']) }}"
                                                            class="btn btn-success">Start</a>
                                                    @elseif($student->status == 'pending')
                                                        @if (is_null($student->tutor_id))
                                                            <a href="{{ route('admin.shared.inquiry_forward', [$student->id]) }}"
                                                    ...
                                                    @if ($student->status != 'cancelled')
                                                        <a href="{{ route('admin.shared.change.inquiry.status', [$student->id, 'cancelled']) }}"
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a class="btn btn-info text-white payment-link"
                                                        data-id="{{ $student->id }}"
                                                        data-mail="{{ $student->user->email }}">Payment Link</a>
                                                @endif
