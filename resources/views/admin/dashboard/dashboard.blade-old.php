...
<div class="row">
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.inquiries') }}?q=total">
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.inquiries') }}?q=started">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.inquiries') }}?q=on_trial">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.inquiries') }}?q=not_start">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.financial.statement')}}?from={{  \Carbon\Carbon::today()->subDays(7)->format('Y/m/d') }}&to={{  \Carbon\Carbon::today()->format('Y/m/d') }}">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
                        <h2 class="text-bold-700 mb-0 text-dark">${{$weekly_expense ?? '0'}}</h2>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.financial.statement')}}">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
                        <h2 class="text-bold-700 mb-0 text-success">${{$all_revenue ?? '0'}}</h2>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="card">
            <a href="{{ route('admin.financial.statement')}}">
                <div class="card-header d-flex align-items-start pb-0">
                    <div>
                        <h2 class="text-bold-700 mb-0 text-danger">${{$all_expense ?? '0'}}</h2>
