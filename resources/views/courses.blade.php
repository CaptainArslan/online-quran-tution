        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-md-6 mt-5">
                    ...
                    <h2 class="text-skin">
                        Interactive learnings that <br>
                        delivers the teaching of <br>
                        The Holy Quran in the most <br>
                        compatible way
                    </h2>
                    <p class="text-skin">
                        We offer comprehensive online Quran classes for all age groups at <br>
                        different levels ranging from beginners to those advancing on a <br>
                        journey towards Hifz.
                    </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 green-background p-0">
                    <img src="{{ asset('/public/dist/img/exports/memorization-course.png') }}" alt=""
                        class="img-fluid" />
