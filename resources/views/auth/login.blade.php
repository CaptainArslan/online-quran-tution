...
<head>
    ...
    <title>Login Page - liveTutoring</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin_theme')}}/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{asset('admin_theme')}}/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('admin/login') }}">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input type="password" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="current-password" id="password" placeholder="Password" required>
                                                        @error('password')
                                                        <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                        </span>
