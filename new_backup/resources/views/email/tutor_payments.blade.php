        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center"
            ...
            <tr>
                <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;  padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
                    ...
                    Payments are Successfully Transfered
                </td>
            </tr>
            <tr>
                <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
            ...
            <tr>
                <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
                    ...
                    We are pleased to inform you that your Payments are released now by the Administrator Authority of Live Learning Portal.Following are the details of Payouts.
                </td>
            </tr>
            ...
            <tr>
                <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
                    ...
                    <div style="padding-bottom: 5px;">Name: <strong style="color: #bbb;font-size: 18px;">{{ $data['user'] }}</strong></div>
                    <div style="padding-bottom: 5px;">Email: <strong style="color: #bbb;font-size: 18px;">{{ $data['email'] }}</strong></div>
                    <div style="padding-bottom: 5px;">Amount: <strong style="color: #bbb;font-size: 22px;">{{ $data['amount'] }}</strong></div>
                    <div style="padding-bottom: 5px;">Paid Date: <strong style="color: #bbb;font-size: 18px;">{{ $data['paid_date'] }}</strong></div>
            ...
            <tr>
                <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
                    ...
                    <a href="{{ url('admin/login') }}" target="_blank" style="text-decoration: none;">
