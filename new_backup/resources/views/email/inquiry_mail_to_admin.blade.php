			...
			<table border="0" cellpadding="0" cellspacing="0" align="center"
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;  padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
						...
						New Student Inquiry is Submitted
					</td>
				</tr>
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
				...
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
						...
						A new user <strong>{{$data['user']->name}}</strong> has send an inquiry, Here are the details of the student inquiry
					</td>
				</tr>
				...
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
						...
						<div style="padding-bottom: 5px;">Student ID: <strong style="color: #bbb;font-size: 18px;">{{$data['user']->id}}</strong></div>
						<div style="padding-bottom: 5px;">Student Name: <strong style="color: #bbb;font-size: 18px;">{{$data['user']->name}}</strong></div>
						<div style="padding-bottom: 5px;">Student Email: <strong style="color: #bbb;font-size: 18px;">{{$data['user']->email}}</strong></div>
						<div style="padding-bottom: 5px;">Student Phone: <strong style="color: #bbb;font-size: 18px;">{{$data['user']->phone}}</strong></div>
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
						...
						<a href="{{route('admin/login')}}" target="_blank" style="text-decoration: none;">
