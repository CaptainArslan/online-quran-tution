...
@section('content')
    ...
    <section id="section-features" class="mt-4">
        <div class="container" style="position:relative;">
            <div class="dis-hide"
                style="border-left: 1.5px solid #ccc;height: 100%;position: absolute;left: 50%;margin-left: -3px;top: 0;">
            </div>
            <div class="row">
                            ...
                            <a href="{{ route('blog.detail', ['id' => $blog->id, 'slug' => $blog->slug]) }}"
                                ...
                                <div class="card green-background text-skin">
                                    <div class="card-title">
                                        ...
                                        <img src="{{ asset('/public/dist/img/exports/Rectangle 153.png') }}"
                                            class="w-100 blog-image " style="">
                                    </div>
        ...
        <div class="row justify-content-center mt-3">
            {{ $blogs->links('vendor.pagination.custom-styling')}}
        </div>
    </section>
    <!-- content close -->
