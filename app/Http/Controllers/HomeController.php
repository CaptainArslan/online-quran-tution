...
class HomeController extends Controller
{
    ...
    {
        $title = 'Highly Qualified Quran Teachers | Online Quran Classes For Kids With Tajweed';
        ...
        $c1h = 'Quran Reading';
        $c1 = "It's one of the essential practices learned by Muslim kids whose native language is not Arabic. Our Islamic teachers are well-qualified to teach this course online to your kids and adults. This course takes about three years of Duration for completing the whole Quran reading. Don't worry about our lectures; we provide One-on-one interactive lessons and single Quran teachers to single teachers for better attention. If you want to see your kids read Quran accurately, then join our Nottingham online Quran classes.";
        $c2h = 'Quran Memorization';
        $c2 = "It's another practice of the Islamic religion for enlightening the heart with the light of the Quran. Allah becomes very happy after knowing that His person remembers His book with total dedication and sincerity. As a result, Allah gives a lot of rewards to Hafiz-e-Quran in the world and hereafter. People in Nottingham don't have Quran Madrassas nearby. Hence, they can join our Quran Memorization lectures online in Nottingham to memorize unforgettable Quran with accurate pronunciation.";
        $c3h = 'Tajweed-Ul-Quran';
        $c3 = "It's essential to read Quran according to Tajweed rules. Tajweed means proficiency and accuracy, and Tajweed-Al-Quran signifies reading Quran with precision and exactitude. Muslims learn Nazra and read Quran in a simple tone, but we should read Quran as Commanded by Allah to read with a cadent style. If you wish to improve your Arabic ascent of the Quran, you must join our Tajweed lectures online in Nottingham because we have the best Tajweed teacher who teaches you interactive learning.";
        $r1h = 'Interactive classes';
        $r1 = 'The first benefit of choosing our Nottingham online Quran tuition is that you will get interactive Quran lectures. We used both advanced and ancient tools but made our lectures accessible and handy for everyone, either kids or adults. Our best Islamic teachers make sure to provide interactive learning to our students.';
        $r2h = 'Schedule flexibility';
        $r2 = "Another benefit is that you'll receive schedule flexibility in taking your Quran lectures online in Nottingham. Yes! You will decide on which time you'll be available to take your course quickly. Besides, it would be best if you also discussed with your teacher for his/her availability suited your selected time or not. Then, after consulting with your teacher, you can set the timing and take your lecture at that time.";
        $r3h = 'Monthly classes  ';
        $r3 = "Another advantage is that we've also allowed our students to get the opportunity of a monthly pricing plan. These monthly Quran classes are mainly organized for needy people who can't afford long-term fee plans. Therefore, they can choose month-to-month Quran classes carefreely.";
        ...
        $r5 = 'The benefit of allowing one-on-one classes is that a single teacher will teach a single student. In this way, the student will get more attention during lessons and learn Quran effectively. The one-on-one lecture will take place on Zoom/Skype by either video or audio call and sharing screen';
        ...
        $description = 'An online learning platform caters to Muslims who seek the ability to read The Holy Quran all from the comfort of their own home. We provide online classes for your kids to inhibit learning skills of the Quran.';
        $review = Testimonial::where('status', 1)->where('rating', 5)
            ->orWhere('rating', 4)->orWhere('rating', 3)->orWhere('rating', 2)
            ->orWhere('rating', 1)->count();
        ...
        $star1 = Testimonial::where('status', 1)->where('rating', 1)->count();
        $minititle = '';
        $heroHeading = 'Are you searching for Online Quran classes for kids?';
        $heroP1 = 'An online learning platform designed to cater for Muslims <br> who seek the ability to read The Holy Quran all from <br> the comfort of their own home.';
        ...
        $sectionBody = 'Stop beating the dead horse and get your kids registered with us. We have several highly qualified Quran teachers to help your kids learn Quran online with Tajweed concepts and from basics to end reading it accurately and fluently. In addition, we allow you to book a one-on-one Quran class for kids if they are hesitant to learn with others, followed by a flexible schedule and a competitive price plan. Furthermore, our online staff is well aware of online tools to deliver an interactive Quran lesson for kids during a session and consists of both male and female English-speaking Quran teachers for children. As a new visitor, we allow you to enrol your kid in Quran for children’ one-day free trial class and check our services. So what are you waiting for? Book your trial class and start learning now';

        $faqs = [
            [
                'question' => 'Can I rate or replace the Quran tutor for children?',
                'answer' => 'Alhamdulillah, we are blessed with the best Quran teachers for online Quran classes for children. We have chosen Quran tutors for children according to their Islamic qualifications and experience to ensure providing excellent Quran teaching services during a session. But upon dissatisfaction, we surely allow you to replace the Quran tutor for children with the one recommended by you or get a full refund',
            ],
            [
                'question' => 'Can I rate or replace the Quran tutor for kids?',
                'answer' => "As a parent, it is pretty easy to check your child’s performance. We allow you to watch and listen to your child's online Quran lectures and check their growth via monthly evaluations. This is one of the best options available to keep an eye on children reading and Quran recitation practices.",
            ],
            [
                'question' => 'What is the method of joining online Quran lectures for children?',
                'answer' => 'The process of joining online kids’ Quran classes is very simple and effortless. However, we recommend you to have a Laptop or smartphone to take a lecture online. Firstly, you have to create your account on the online software recommended by Quran tutors for children near me. Once the account is created, the tutor will call you at a decided time, and upon receiving the call, the Quran lesson starts to proceed. The tutor will share his/her screen and open the digital Quran to start the lesson. At the start of the lecture, your Quran teacher will revise the previous lesson, listen to your recitation, and highlight the mistakes on the digital Quran to help you fix your mistakes and learn Quran recitation and reading accurately and fluently.',
            ],
            [
                'question' => 'Is it possible to check out online Quran classes for children as a free trial lecture?',
                'answer' => 'Yes, we provide you with the opportunity of trial classes to check out our way of teaching the Quran and the validity of our online Quran classes for children. We permit you to book a one-day free trial lecture, and upon satisfaction, you can register yourself for a regular session. Note: There is no fee for registration',
            ],
        ];
    ...
    {
        $title = 'Learn Quran online| Online Madrasa UK';
        $schemafaq = '<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      ...
      "text": "Yes, for sure, you are free to quit online Madrassah any time. You can quit it right after the trial class as well if you are not dissatisfied with the Madrassah teacher’s performance."
        ...
        $c1h = 'Quran Reading';
        $c1 = "It's one of the essential practices learned by Muslim kids whose native language is not Arabic. Our Islamic teachers are well-qualified to teach this course onstream to your kids and adults. This course takes about three years of Duration for completing the whole Quran with Tajweed. Don't worry about our lectures; we provide One-on-one interactive lessons and single teachers to single teachers for better attention. If you want to see your kids read Holy Book accurately, then join our Nottingham onstream lectures.";
        $c2h = 'Quran Memorization';
        $c2 = "It's another practice of the Islamic religion for enlightening the heart with the light of the Quran. Allah becomes very happy after knowing that His person remembers His book with total dedication and sincerity. As a result, Allah gives a lot of rewards to Hafiz-e-Quran in the world and hereafter. People in Nottingham don't have Quran Madrassas nearby. Hence, they can join our Quran Memorization lectures onstream in Nottingham to memorize unforgettable Quran with accurate pronunciation.";
        $c3h = 'Tajweed-Ul-Quran';
        $c3 = "It's essential to read Quran according to Tajweed rules. Tajweed means proficiency and accuracy, and Tajweed-Al-Quran signifies reading with precision and exactitude. Muslims learn Nazra and read Quran in a simple tone, but we should read it as Commanded by Allah to read it with a cadent style. If you wish to improve your Arabic ascent of the Holy Book, you must join our Tajweed lectures onstream in Nottingham because we have the best Tajweed teacher who teaches you interactive learning.";
        $r1h = 'Interactive classes';
        $r1 = 'The first benefit of choosing our Nottingham onstream Quran tuition is that you will get interactive lessons. We used both advanced and ancient tools but made our lessons accessible and handy for everyone, either kids or adults. Our best Islamic teachers make sure to provide interactive lessons to our students.';
        $r2h = 'Schedule flexibility';
        $r2 = "Another benefit is that you'll receive schedule flexibility in taking your Quran lectures onstream in Nottingham. Yes! You will decide on which time you'll be available to take your course quickly. Besides, it would be great if you also discussed with your teacher for his/her availability suited your selected time or not. Then, after consulting with your teacher, you can set the timing and take your lesson at that time.";
        $r3h = 'Monthly classes  ';
        $r3 = "Another advantage is that we've also allowed our students to get the opportunity of a monthly pricing plan. These monthly lectures are mainly organized for needy people who can't afford long-term fee plans. Therefore, they can choose month-to-month lectures care freely.";
        $r4h = 'Female Quran teacher ';
        $r4 = "We've arranged female teachers for girls and ladies because some girls don't prefer to learn it from a male teacher near me. Our female staff is very cooperative and deals with students' problems in a very engaging way. Islamic sisters living in Nottingham can join our Quran lectures onstream without hesitation.";
        $r5h = 'One-on-one classes';
        $r5 = 'The benefit of allowing one-on-one lectures is that a single teacher will teach a single student. In this way, the student will get more attention during lessons and learn Holy Book effectively. The one-on-one class will take place on Zoom/Skype via either video or audio call and sharing screen.';
        $r6h = 'Free trial classes';
        $r6 = 'Most importantly, we are giving our students to take trial lectures for free. They can take free trial lectures for three days to check out the teaching strategy of Nottingham Quran lectures. Then, if you feel that our teaching method suits you, you can proceed with continuous lectures.';
        $p2h = "Our Best Quran teachers";
        $p2 = "Every Muslim parent desires their kids to remembers Quran to get the reward from Allah in the world and hereafter. This course may take about three or more years; otherwise, the duration depends on the intellectuality of students. But our Quran teachers Leeds try their best to fill student's hearts with the light of the Quran. In addition to listening to daily Quran lessons, we also have arranged Quran worksheets in PDF form for better practice.";
        $description = 'An online learning platform for Muslims who seek the ability to read The Holy Quran all from the comfort of their own home, from knowledgeable teachers';
        $review = Testimonial::where('status', 1)->where('rating', 5)
            ->orWhere('rating', 4)->orWhere('rating', 3)->orWhere('rating', 2)
            ->orWhere('rating', 1)->count();
        ...
        $star2 = Testimonial::where('status', 1)->where('rating', 2)->count();
        $star1 = Testimonial::where('status', 1)->where('rating', 1)->count();
        $heroHeading = 'Best Online Madrassah for Quran in the UK';
        $heroP1 = "An onstream learning platform designed to cater to Muslims who seek the ability to read The Holy Book all from the comfort of their own home.";
        $Alhamdulillah = "Alhamdulillah";
        $minititle = 'Find a tutor to learn Quran online.';
        $headings1 = 'Find a tutor to learn Quran online';
        $headings2 = '';
        $testimonials = Testimonial::where('status', 1)->orderBy('id', 'DESC');
        $sectionBody = 'Well, the worrisome time is over. We are offering an onstream Madrassah teaching facility to you with our highly qualified Islamic teachers to enable you and your kids to learn and read Quran proficiently. In our onstream Madrassah lessons, we have English-speaking Male and Female Quran teachers who are well aware of onstream tools to deliver an interactive Lesson during a session. The most amazing part of online Quran Academy United Kingdom is that we provide one-on-one lessons to individuals to avoid hesitation, and instead of yearly, we allow you to pay a month-to-month online Madrassah fee. Furthermore, to satisfy you with our services, we allow you to take a 1-day free trial lesson to evaluate our teaching criteria and join our regular session upon satisfaction. So, hurry up and book now!';

        $faqs = [
            [
                'question' => 'How can I register myself for online Madrassah lectures?',
                'answer' => 'The registration method for Madrassah lectures in the United Kingdom is quite simple and easy. To join a one-day free trial class, you need to fill out the booking form with complete and correct information, including full name, contact number, email address, and message (optional), and submit it to us. After the submission, we will get back to you as soon as possible, within 24 hours, for registration confirmation and to answer your queries.',
            ],
            [
                'question' => 'Why are online Madrassah lectures better than local Madrassahs?',
                'answer' => 'Several reasons make onstream Madrassah lectures better than local Madrassahs. One of the notable benefits is that you do not have to go out to a local Madrassah, which saves you time and allows you to learn Quranic lessons with Tajweed concepts with well-versed Madrassah teachers. In addition to this, you can record your Quran lessons and can play them later whenever you need to revise them. Moreover, besides male teachers, girls can avail of the specific option of booking a Female tutor near me option as well for their ease. And to reduce the Quran course fee burden from your shoulders, onstream Madrassah offers cheap Quran teachings and allows you to submit lesson fees at a reasonable monthly price plan.',
            ],
            [
                'question' => 'Can I get a tutor’s replacement if I am dissatisfied with his/her performance?',
                'answer' => 'For sure, you can, if you are not satisfied with the teaching method of your teacher at onstream Madrassah, discuss the matter with us. We will pay heed to the reason provided by you for the tutor’s replacement, and if it is a valid reason, we will process your request and surely change your Madrassah teacher onstream with the one recommended by you.',
            ],
            [
    ...
    {
        $title = 'Highly Qualified Quran Teachers | Online Islamic School';
        $c1h = 'Quran Reading';
        $c1 = "It's one of the essential practices learned by Muslim kids whose native language is not Arabic. Our teachers are well-qualified to teach this course onstream to your kids and adults. This course takes about three years of Duration for completing the whole Quran reading. Don't worry about our classes; we provide One-on-one interactive lessons and single Quran teachers to single teachers for better attention. If you want to see your kids read Quran accurately, then join our Nottingham online Quran classes.";
        $c2h = 'Quran Memorization';
        $c2 = "It's another practice of the religion for enlightening the heart with the light of the Quran. Allah becomes very happy after knowing that His person remembers His book with total dedication and sincerity. As a result, Allah gives a lot of rewards to Hafiz-e-Quran in the world and hereafter. People in Nottingham don't have Quran Madrassas nearby. Hence, they can join our Quran Memorization classes online in Nottingham to memorize unforgettable Quran with accurate pronunciation.";
        $c3h = 'Tajweed-Ul-Quran';
        $c3 = "It's essential to read Quran according to Tajweed rules. Tajweed means proficiency and accuracy, and Tajweed-Al-Quran signifies reading Quran with precision and exactitude. Muslims learn Nazra and read Quran in a simple tone, but we should read Quran as Commanded by Allah to read with a cadent style. If you wish to improve your Arabic ascent of the Quran, you must join our Tajweed classes onstream in Nottingham because we have the best Tajweed teacher who teaches you interactive learning.";
        $r1h = 'Interactive classes';
        $r1 = 'The first benefit of choosing our Nottingham onstream Quran tuition is that you will get interactive Quran classes. We used both advanced and ancient tools but made our classes accessible and handy for everyone, either kids or adults. Our best teachers make sure to provide interactive learning to our students.';
        $r2h = 'Schedule flexibility';
        $r2 = "Another benefit is that you'll receive schedule flexibility in taking your Quran classes onstream in Nottingham. Yes! You will decide on which time you'll be available to take your course quickly. Besides, it would be best if you also discussed with your teacher for his/her availability suited your selected time or not. Then, after consulting with your teacher, you can set the timing and take your class at that time.";
        $r3h = 'Monthly classes';
        $r3 = "Another advantage is that we've also allowed our students to get the opportunity of a monthly pricing plan. These monthly Quran classes are mainly organized for needy people who can't afford long-term fee plans. Therefore, they can choose month-to-month Quran classes care freely.";
        $r4h = 'Female Quran teacher ';
        $r4 = "We've arranged female Quran teachers for girls and ladies because some girls don't prefer to learn Quran from a male Quran teacher near me. Our female staff is very cooperative and deals with students' problems in a very engaging way. Sisters living in Nottingham can join our Quran classes onstream without hesitation.";
        $r5h = 'One-on-one classes';
        $r5 = 'The benefit of allowing one-on-one classes is that a single teacher will teach a single student. In this way, the student will get more attention during lessons and learn Quran effectively. The one-on-one class will take place on Zoom/Skype via either video or audio call and sharing screen.';
        $r6h = 'Free trial classes';
        $r6 = 'Most importantly, we are giving our students the to take trial classes for free. They can take free trial classes for three days to check out the teaching strategy of Nottingham Quran classes. Then, if you feel that our teaching method suits you, you can proceed with continuous Quran classes.';
        $p2h = "Our Best Quran teachers";
        $p2 = "Every Muslim parent desires their kids to remembers Quran to get the reward from Allah in the world and hereafter. This course may take about three or more years; otherwise, the duration depends on the intellectuality of students. But our Quran teachers Leeds try their best to fill student's hearts with the light of the Quran. In addition to listening to daily Quran lessons, we also have arranged Quran worksheets in PDF form for better practice.";
        $schemafaq = '<script type="application/ld+json">
...
';
        $schema = '<script type="application/ld+json">
                ...
                ';
        $description = 'An online learning school caters to Muslims who seek the ability to read The Holy Quran all from the comfort of their own home.';
        $review = Testimonial::where('status', 1)->where('rating', 5)
            ->orWhere('rating', 4)->orWhere('rating', 3)->orWhere('rating', 2)
            ->orWhere('rating', 1)->count();
        ...
        $star1 = Testimonial::where('status', 1)->where('rating', 1)->count();
        $minititle = 'Find a tutor to learn Quran online.';
        $heroHeading = 'Online Islamic School for Quran';
        $heroP1 = 'An onstream learning platform designed to cater to Muslims who seek the ability to read The Holy Quran all from the comfort of their own home.';
        $Alhamdulillah = 'Alhamdulillah';
        $headings1 = 'Find a tutor to learn Quran online.';
        $headings2 = '';
        $testimonials = Testimonial::where('status', 1)->orderBy('id', 'DESC');
        $sectionBody = 'Well, don’t worry. We are here to cater for your needs-related lessons for kids. We have a group of highly qualified and English-speaking Quran tutors for kids who are mainly focusing on Short courses for children to help them gain basic knowledge of studies and Quran knowledge with interpretations at a competitive monthly price plan. Furthermore, we allow you to book a one-on-one session to avoid hesitation and get all the needed attention during a session of lessons for kids onstream. To resolve a matter of every student, alongside males, we have female tutors available on our website for children as well so that female kids can learn lessons to the fullest. Additionally, to evaluate lessons for kids, we offer you a one-day free trial class. So hurry up and book yours now!';
        $faqs = [
            [
                'question' => 'What is the method of taking lessons of school for kids onstream?',
                'answer' => 'Once you are registered with us and set up the system to join our onstream short courses. Our Quran tutor will call you on a recommended app at a selected time according to the schedule. You have to receive the call instantly, and upon receiving the call live session will start, and he/she will share his/her screen to show a digital lesson book on the screen, which both tutor and student can see and start delivering the lecture.',
            ],
            [
                'question' => 'How can I register myself for lesson classes?',
                'answer' => 'It is a very easy process to enroll in short courses. Firstly, you have to fill out the registration form available onstream and submit it to us. After receiving the form, our onstream staff will get back to you as soon as possible, within 24 hours, through the contact number or email address provided by you for registration confirmation.<br> Alongside, our teachers will guide you about the installation and usage of recommended apps to join online lessons with ease.',
            ],
            [
                'question' => 'Is there any fee for booking a free trial class at an Islamic school United Kingdom?',
            ...
            [
                'question' => 'How can I take online lessons at school if I am not a computer expert?',
                'answer' => 'To join our online Islamic lessons for kids, you don’t need to be a computer expert. Once you are registered with us, our online staff and tutors will guide you about the installation and usage of the recommended tool, and within a few minutes, you will be able to join our short course session.',
            ],
        ];
    ...
    {
        $title = 'Highly Qualified Online Quran Teachers | Skype Quran Classes';
        $c1h = 'Quran Reading';
        ...
        $r1h = 'Interactive classes';
        $r1 = 'The first benefit of choosing our Nottingham online Quran tuition is that you will get interactive Quran classes via skype. We used both advanced and ancient tools but made our classes accessible and handy for everyone, either kids or adults. Our best Islamic teachers make sure to provide interactive learning to our students.';
        $r2h = 'Schedule flexibility';
        ...
        $r3h = 'Monthly classes';
        $r3 = "Another advantage is that we've also allowed our students to get the opportunity of a monthly pricing plan. These monthly Quran classes are mainly organized for needy people and can't afford long-term fee plans. Therefore, they can choose month-to-month Quran classes carefreely.";
        $r4h = 'Female Quran teacher ';
        $r4 = "We've arranged female Quran teachers for girls and ladies because some girls don't prefer to learn Quran from a male Quran teacher near me on skype. Our female staff is very cooperative and deals with students' problems in a very engaging way. Islamic sisters living in Nottingham can join our Quran classes online without hesitation.";
        $r5h = 'One-on-one classes';
...
<script type="application/ld+json">
        ...
        $description = 'An online platform for Muslims via skype who wills to read The Holy Quran via from the comfort of their home.';
        $review = Testimonial::where('status', 1)->where('rating', 5)
            ->orWhere('rating', 4)->orWhere('rating', 3)->orWhere('rating', 2)
            ->orWhere('rating', 1)->count();
        ...
        $star1 = Testimonial::where('status', 1)->where('rating', 1)->count();
        $minititle = 'Find a tutor to learn Quran online.';
        $heroHeading = 'Quran Majeed online via skype';
        $Alhamdulillah = 'Alhamdulillah';
        $heroP1 = 'An online learning platform designed to cater for Muslims who seek the ability to read The Holy Quran all from the comfort of their own home.';
        $headings1 = 'Find a tutor to learn Quran online.';
        $headings2 = '';
        $testimonials = Testimonial::where('status', 1)->orderBy('id', 'DESC');
        $sectionBody = 'We got you covered in this regard and provide you the opportunity to take Skype Quran lessons with the best Quran tutors at a reasonable monthly price plan. Our staff is diligently working to facilitate you and provide you with various short Islamic courses, Skype Quran lessons, and one-on-one sessions. We provide Quran services for all students without any age discrimination to help them learn Quran from basics to end it reading fluently and accurately. We have highly qualified and English-speaking Quran tutors for delivering Skype Quran teachings with a 100% satisfaction guarantee. Furthermore, our online Skype Quran sessions allow you to decide the class timings according to your availability so that no hindrance occurs during your learn Quran online Skype session. So, get yourself registered for a free Skype trial class to evaluate our teaching methodology and join our regular session upon satisfaction.';
        $faqs = [
            [
            ...
            [
                ...
                'answer' => 'No, if it is hard for you to submit the whole course fee, then don’t worry. We got your back. You can submit the course fee at a reasonable monthly price plan. Our Skype Quran classes are very cheap, and every person can afford them easily. In addition, we do not bound you to submit a fee per course or on a monthly basis. You can do whatever is feasible for you.',
            ],
            [
...
<script type="application/ld+json">
        ...
        $schema = '<script type="application/ld+json">
                        ...
                        ';
        $c1h = 'Quran Reading';
        $c1 = "It's one of the essential practices learned by Muslim kids whose native language is not Arabic. Our Islamic teachers are well-qualified to teach this course online to your kids and adults. This course takes about three years of Duration for completing the whole Quran reading. Don't worry about our lectures; we provide One-on-one interactive lessons and single Quran teachers to single teachers for better attention. If you want to see your kids read Quran accurately, then join our Nottingham online Quran lectures.";
        $c2h = 'Quran Memorization';
        $c2 = "It's another practice of the Islamic religion for enlightening the heart with the light of the Quran. Allah becomes very happy after knowing that His person remembers His book with total dedication and sincerity. As a result, Allah gives a lot of rewards to Hafiz-e-Quran in the world and hereafter. People in Nottingham don't have Quran Madrassas nearby. Hence, they can join our Quran Memorization lessons online in Nottingham to memorize unforgettable Quran with accurate pronunciation.";
        $c3h = 'Tajweed-Ul-Quran';
        $c3 = "It's essential to read Quran according to the rules. Tajweed means proficiency and accuracy, and Tajweed-Al-Quran signifies reading Quran with precision and exactitude. Muslims learn Nazra and read Quran in a simple tone, but we should read Quran as Commanded by Allah to read with a cadent style. If you wish to improve your Arabic ascent of the Quran, you must join our lessons online in Nottingham because we have the best teacher who teaches you interactive learning.";
        $r1h = 'Interactive classes';
        $r1 = 'The first benefit of choosing our Nottingham online Quran tuition is that you will get interactive Quran lessons. We used both advanced and ancient tools but made our lessons accessible and handy for everyone, either kids or adults. Our best Islamic teachers make sure to provide interactive learning to our students.';
        $r2h = 'Schedule flexibility';
        $r2 = "Another benefit is that you'll receive schedule flexibility in taking your Quran lessons online in Nottingham. Yes! You will decide on which time you'll be available to take your course quickly. Besides, it would be best if you also discussed with your teacher for his/her availability suited your selected time or not. Then, after consulting with your teacher, you can set the timing and take your lesson at that time.";
        $r3h = 'Monthly lectures';
        $r3 = "Another advantage is that we've also allowed our students to get the opportunity of a monthly pricing plan. These monthly Quran lessons are mainly organized for needy people who can't afford long-term fee plans. Therefore, they can choose month-to-month Quran lessons carefree.";
        $r4h = 'Female Quran teacher ';
        $r4 = "We've arranged female Quran teachers for girls and ladies because some girls don't prefer to learn Quran from a male Quran teacher. Our female staff is very cooperative and deals with students' problems in a very engaging way. Islamic sisters living in Nottingham can join our Quran lessons online without hesitation.";
        $r5h = 'One-on-one lessons';
        $r5 = 'The benefit of allowing one-on-one lectures is that a single teacher will teach a single student. In this way, the student will get more attention during lessons and learn Quran effectively. The one-on-one lesson will take place on Zoom/Skype via either video or audio call and sharing screen.';
        $r6h = 'Free trial lectures';
        $r6 = 'Most importantly, we are giving our students to take trial lectures for free. They can take free trial lessons for three days to check out the teaching strategy of Nottingham Quran lessons. Then, if you feel that our teaching method suits you, you can proceed with continuous Quran lessons.';
        $p2h = "Our Best Quran teachers";
        $p2 = "Every Muslim parent desires their kids to remembers Quran to get the reward from Allah in the world and hereafter. This course may take about three or more years; otherwise, the duration depends on the intellectuality of students. But our Quran teachers Leeds try their best to fill student's hearts with the light of the Quran. In addition to listening to daily Quran lessons, we also have arranged Quran worksheets in PDF form for better practice.";
        $description = 'An online learning platform for Muslims to read Quran with Tajweed.';
        $review = Testimonial::where('status', 1)->where('rating', 5)
            ->orWhere('rating', 4)->orWhere('rating', 3)->orWhere('rating', 2)
            ->orWhere('rating', 1)->count();
        ...
        $heroHeading = 'Opportunity of Tajweed classes near me';
        $Alhamdulillah = 'Alhamdulillah';
        $heroP1 = 'An online learning platform designed to cater for Muslims <br> who seek the ability to read The Holy Quran all from <br> the comfort of their own home.';
        $headings1 = 'Online Tajweed course';
        $headings2 = '';
        $testimonials = Testimonial::where('status', 1)->orderBy('id', 'DESC');
        $sectionBody = 'Stay connected with us because we are offering one-on-one Quran with Tajweed sessions with our highly trained and certified Quran tutors to let you learn Quran proficiently with concepts. All of our Tajweed-ul-Quran teachers can speak English fluently and are well aware of online tools to deliver an interactive online course without interruptions during a session. Besides male tutors, we provide you female tutor option to teach our Islamic sisters Quran with Tajweed. Furthermore, we allow you to decide your lesson timings according to your availability so nothing that you can learn Quran on a hectic day with ease. To cater to your satisfaction concerns, we are allowing a 1-day free trial of lessons, and once you are satisfied with our teaching method, you can join our regular session. So, what are you waiting for? Book your course now!';
        $faqs = [
            [
                'question' => 'How can I register myself for online Tajweed ul Quran courses?',
                'answer' => 'To register yourself with us for lessons is very easy and simple. Firstly, you have to fill the booking form available at our site by providing all the correct information and submitting it to us. Once the booking process is completed, our online staff will contact you via email or the contact number provided by you on the booking form for registration confirmation. After that, our Quran tutors will guide you about installing and using the recommended app for joining interactive sessions with ease',
            ],
            [
                'question' => 'Are there any age limits for joining online lessons?',
                'answer' => 'Fortunately, we have no exclusions related to age groups for taking online lessons. Students of all age groups are free to join our online courses. If you are hesitant to join a lesson on Quran with the session with others. In that case, we provide you the opportunity to book a one-on-one Quran course in which a single tutor will teach a solo student to avoid hesitation and interruption.',
            ],
            [
                'question' => 'Are parents get to report the kid’s performance during a Quran with Tajweed lesson?',
                'answer' => 'Yes, we know the concern of parents and provide you the opportunity to get reported about your kid’s performance during a lecture by a Quran tutor. On a monthly basis, our Quran teachers will inform you about your kid’s performance so that you can analyze that where he/she is standing and ensure that he/she will work hard to raise the progress graph.',
            ],
            [
                'question' => 'IIs there a female Tajweed-ul-Quran tutor available for online lessons?',
                'answer' => 'Yes, Alhamdulillah, we are blessed with a large group of well-versed Tajweed-ul-Quran tutors, including both Male and female teachers. We understand that girls are hesitant to join online lectures with male tutors; thus, we provide a female tutor option specifically available for our Islamic sisters and kids. They will help the girl students to learn Quran with Tajweed and resolve every matter faced by a student during an online lecture.',
            ],
        ];
    ...
    {
        $title = 'Highly Preferred Classes | Online Quran Hifz Program';
        $schemafaq = '<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "FAQPage",
...
<script type="application/ld+json">
        ...
        $schema = '<script type="application/ld+json">
                    ...
                    ';
        $c1h = 'Quran Reading';
        $c1 = "It's one of the essential practices learned by Muslim kids whose native language is not Arabic. Our Islamic teachers are well-qualified to teach this course online to your kids and adults. This course takes about three years of Duration for completing the whole Holy Book reading. Don't worry about our classes; we provide One-on-one interactive lessons and single teachers to single teachers for better attention. If you want to see your kids read it accurately, then join our Nottingham online classes.";
        $c2h = 'Quran Memorization';
        $c2 = "It's another practice of the Islamic religion for enlightening the heart with the light of the Holy Book. Allah becomes very happy after knowing that His person remembers His book with total dedication and sincerity. As a result, Allah gives a lot of rewards to Hafiz in the world and hereafter. People in Nottingham don't have Madrassas nearby. Hence, they can join our Quran Hifz classes online in Nottingham to memorize the unforgettable Holy Book with accurate pronunciation.";
        $c3h = 'Tajweed-Ul-Quran';
        $c3 = "It's essential to read it according to Tajweed rules. Tajweed means proficiency and accuracy, and Tajweed-Al-Quran signifies reading with precision and exactitude. Muslims learn Nazra and read it in a simple tone, but we should read it as Commanded by Allah to read with a cadent style. If you wish to improve your Arabic ascent of the Holy Book, you must join our Tajweed lessons online in Nottingham because we have the best Tajweed teacher who teaches you interactive learning.";
        $r1h = 'Interactive classes';
        $r1 = 'The first benefit of choosing our Nottingham online tuition is that you will get interactive lessons. We used both advanced and ancient tools but made our lectures accessible and handy for everyone, either kids or adults. Our best Islamic teachers make sure to provide interactive learning to our students.';
        $r2h = 'Schedule flexibility';
        $r2 = "Another benefit is that you'll receive schedule flexibility in taking your lessons online in Nottingham. Yes! You will decide on which time you'll be available to take your course quickly. Besides, it would be best if you also discussed with your teacher for his/her availability suited your selected time or not. Then, after consulting with your teacher, you can set the timing and take your lecture at that time.";
        $r3h = 'Monthly lessons';
        $r3 = "Another advantage is that we've also allowed our students to get the opportunity of a monthly pricing plan. These monthly lessons are mainly organized for needy people who can't afford long-term fee plans. Therefore, they can choose month-to-month lectures care freely.";
        $r4h = 'Female Quran teacher ';
        $r4 = "We've arranged female teachers for girls and ladies because some girls don't prefer to learn it from a male teacher near me. Our female staff is very cooperative and deals with students' problems in a very engaging way. Islamic sisters living in Nottingham can join our lectures online without hesitation.";
        $r5h = 'One-on-one lessons';
        $r5 = 'The benefit of allowing one-on-one lectures is that a single teacher will teach a single student. In this way, the student will get more attention during lessons and learn Holy Book effectively. The one-on-one lecture will take place on Zoom/Skype via either video or audio call and sharing screen.';
        $r6h = 'Free trial lectures';
        $r6 = 'Most importantly, we are giving our students to take trial lessons for free. They can take free trial lessons for three days to check out the teaching strategy of Nottingham lectures. Then, if you feel that our teaching method suits you, you can proceed with continuous lessons.';
        $p2h = "Our Best Quran teachers";
        $p2 = "Every Muslim parent desires their kids to remembers Quran to get the reward from Allah in the world and hereafter. This course may take about three or more years; otherwise, the duration depends on the intellectuality of students. But our Quran teachers Leeds try their best to fill student's hearts with the light of the Quran. In addition to listening to daily Quran lessons, we also have arranged Quran worksheets in PDF form for better practice.";
        $description = 'An online learning platform for Muslims who seek the ability to read The Holy Quran all from the comfort of their home, from knowledgeable teachers';
        $review = Testimonial::where('status', 1)->where('rating', 5)
            ->orWhere('rating', 4)->orWhere('rating', 3)->orWhere('rating', 2)
            ->orWhere('rating', 1)->count();
        ...
        $heroHeading = 'Hifz Quran classes near me';
        $heroP1 = 'An online learning platform designed to cater for Muslims who seek the ability to read The Holy Book all from the comfort of their own home.';
        $Alhamdulillah = 'Alhamdulillah';
        $headings1 = 'Hifz-e-Quran program';
        $headings2 = '';

        $testimonials = Testimonial::where('status', 1)->orderBy('id', 'DESC');
        $sectionBody = 'Don’t worry; our Hafiz teachers are here to deliver an interactive Hifz program via online sessions to help you memorize it accurately. Alhamdulillah, we are blessed with a large group of highly qualified and professional male and female Hafiz teachers to enable you to memorize Holy Book from basics to the end proficiently with an Arabic accent. Our online staff communicates in the English language to make you understand things during an online Hifz course easily and provide you with one-on-one memorization sessions at a fantastic month-to-month pricing plan. Furthermore, to satisfy you with our services, we provide you with an opportunity to book a one-day free trial and a free tutor replacement or a full refund if you are dissatisfied. So, what are you waiting for? Register yourself now in our online Hifz classes and start learning.';

        $faqs = [
            [
                'question' => 'How to book a free class or a regular Hifz course?',
                'answer' => 'It is very easy to book a one-day free trial class or a regular hifz program with us. First, you have to go to our site, fill out the booking form, and submit it to us. Our online staff will get back to you within 24 hours for registration confirmation. In addition to this, your tutor guides you about installing and using online software tools. Note: There is no registration fee for booking a trial lecture.',
            ],
            [
                'question' => 'Is it possible to replace the Holy Book learning tutor near me after registration?',
                'answer' => 'Yes, it is possible. We provide you the full opportunity to get a free tutor replacement if you are not satisfied with the performance or teaching method of your tutor. If there is an issue with the tutor, you can discuss it with us. In that case, we will take notice of the issue and pay attention to the reason behind the replacement request. If it is a valid reason, we will provide you the opportunity to get your current teacher replaced by the one recommended by you.',
            ],
            [
                'question' => 'Do you have expert Islamic teachers for the learning of the Holy Book program?',
                'answer' => 'Yes, Alhamdulillah, we are blessed with the best teachers. All teachers near you are highly qualified, experienced, certified, well-trained, and professional to offer you online Lessons. In addition to this, we have both Male and Female certified teachers for boys and girls to avoid any hesitation and trouble during interactive class sessions. Furthermore, do not worry about the background of your Holy Book learning course teacher because we have already checked it, and everything is good to go.',
            ],
            [
                'question' => 'Can I get a full refund upon cancellation of the Holy Book learning course?',
                'answer' => 'Yes, if you are not satisfied with your teacher and want to cancel a booking, we offer you a 100% money-back guarantee. You can discuss the issue with us. We will take notice of your problem, and if your reason is valid, then we will give you a full refund.',
            ],
        ];
